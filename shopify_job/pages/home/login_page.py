...
class LoginPage(BasePage):
    ...
    # Locators
    _captcha="//div[contains(@id,'checkbox')]"
   ...
   #WHAT DO YOU PLAN TO SELL PAGE
    ...
    def login(self, email="", password=""):
        ...
        #self.selectCountry()
        self.log2.sleep(4)
        select_country = self.waitForElement(locator=self._france,timeout=10,
        ...
        self.log2.sleep(4)
        continue_login = self.waitForElement(locator=self._continue_IfLogin,timeout=5,
                                             locatorType="xpath", pollFrequency=1)
        self.elementClick(element=continue_login)
        self.log2.sleep(5)
        captcha_element=self.isElementPresent(locator=self._captcha,locatorType="xpath")
        if captcha_element:


            print("WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWcaptcha element detected")
            input()
            self.emailField()
            self.enterEmail(email)
            #self.log2.sleep(10)
        ...
        self.enterPassword(password)
        # self.log2.sleep(4)
        click_login = self.waitForElement(locator=self._login_in_after_password,timeout=5,
                                                 locatorType="xpath", pollFrequency=1)
    ...
    def verifyLogoutSuccessful(self):
        ...
        result = self.log2.verifyTextMatch(actualText=actual_text, expectedText="You have successfully logged out")
        return result
    #
